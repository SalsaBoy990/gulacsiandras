...
module.exports = {
  ...
  copyHeadersFile: copyHeadersFile,
...
// copy _headers file to the root of /public folder
function copyHeadersFile (srcPath, distPath) {
  'use strict'
  fse.copySync(`${srcPath}/_headers`, `${distPath}/_headers`)
...
// change date format
function convertDateFormat (postData, pathToFile, months) {
  'use strict'
